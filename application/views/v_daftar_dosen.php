...
<div class="ui middle aligned center aligned grid">
  <div class="column">
	...
	<h3>
        ...
        <?php } ?>
    <form class="ui large form" method="post" action="<?php echo base_url().'daftar_dosen/tambah_aksi'?>">
      <div class="ui stacked segment">
        <div class="field">
          <div class="ui left icon input">
            <i class="user icon"></i>
            <input type="text" name="nama" placeholder="Nama Pengguna" required="required" value="<?php echo set_value('nama'); ?>">
          </div>
        </div>
          ...
          <div class="ui left icon input">
            ...
            <input type="nip" name="nip" placeholder="Masukan NIP Dosen" required="required" value="<?php echo set_value('nip'); ?>" >
          </div>
        </div>
        ...
        <div class="field">
          <div class="ui left icon input">
            <i class="lock icon"></i>
            <input type="password" name="pass" placeholder="Password" minlength="8"  required="required" 
    ...
    <div class="ui message">
      Sudah punya akun? <?= anchor('http://localhost/Simple_elearning-master/login_dosen','Login Disini.');?>
    </div>
  </div>
</div>
