      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          <li class="breadcrumb-item">
            <a href="#">E-Learning Siswa MI Hibarmahesa</a>
          </li>
          <li class="breadcrumb-item active">E-Learning untuk siswa</li>   
        </ol>
        <h2><br>Hai, Pemilik NIM <?php echo $this->session->userdata("nim"); ?>
      </h2>
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-primary o-hidden h-100">
              <div class="card-body">
                ...
                <div class="mr-5">Kirim Pesan Ke Admin</div>
              </div>
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-danger o-hidden h-100">
              <div class="card-body">
                ...
                <div class="mr-5">Info Seminar</div>
              </div>
              <a class="card-footer text-white clearfix small z-1" href="#">
                <span class="float-left">Lihat Detail</span>
                <span class="float-right">
