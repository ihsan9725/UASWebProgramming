...
<head>
  ...
  <style type="text/css">
    body {
      background : url(web-image/mac.jpg) no-repeat center center fixed;
...
<div class="ui middle aligned center aligned grid">
  <div class="column">
    ...
    <form class="ui large form" action="<?php echo base_url().'login_dosen/aksi_login';?>" method="POST">
        <div class="ui stacked segment">
        <div class="field">
          <div class="ui left icon input">
            <i class="user icon"></i>
            <input type="text" name="nip" placeholder="Masukkan NIP Dosen">
          </div>
        </div>
        <div class="field">
          <div class="ui left icon input">
    ...
    <div class="ui message">
        <h3><font color="Grey">Belum daftar?</font> <?= anchor('http://localhost/Simple_elearning-master/daftar_dosen','Daftar disini'); ?>
    </div>
  </div>
</div>
